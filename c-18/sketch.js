var caminho,menino,dinheiro,diamantes,joias,espada,fim;
...
function draw() {
  ...
  if(caminho.y > height ){
    ...
    if (dinheiroG.isTouching(menino)) {
      ...
      if(grupoEspada.isTouching(menino)) {
        caminho.velocityY = 0;
        //fim.visible = false;
        grupoEspada.velocityY = 0;
        dinheiroG.velocityY = 0;
        diamantesG.velocityY = 0;
        joiasG.velocityY = 0;
        grupoEspada.lifetime = -1;
        dinheiroG.lifetime = -1;
        diamantesG.lifetime = -1;
        joiasG.lifetime = -1;
    }
  }
  ...
  textSize(20);
  fill(255);
  text("Tesouros: "+ colecaoTesouros,width -150,height -30);
  }
...
function criarDinheiro() {
  ...
  dinheiro.lifetime = window.heigth/3;
...
function criarDiamantes() {
  ...
  diamantes.lifetime = window.heigth/3;
...
function criarJoias() {
  ...
  joias.scale=0.13;
  joias.velocityY = 3;
  joias.lifetime = window.heigth/3;
  joiasG.add(joias);
  }
}
...
function criarEspadas(){
  ...
  espada.scale=0.1;
  espada.velocityY = 3;
  espada.lifetime = window.heigth/3;
